...
ezb_af_ep_desc_t esphome_zb_zha_default_ep_desc_create(uint8_t ep_id, uint16_t device_id, uint8_t device_version,
  ...
  switch (device_id) {
    case EZB_ZHA_ON_OFF_SWITCH_DEVICE_ID: {
      ezb_zha_on_off_switch_config_t config = EZB_ZHA_ON_OFF_SWITCH_CONFIG();
    ...
    case EZB_ZHA_CONFIGURATION_TOOL_DEVICE_ID: {
      ezb_zha_configuration_tool_config_t config = EZB_ZHA_CONFIGURATION_TOOL_CONFIG();
      config.basic_cfg.power_source = power_source;
    ...
    case EZB_ZHA_DOOR_LOCK_DEVICE_ID: {
      ezb_zha_door_lock_config_t config = EZB_ZHA_DOOR_LOCK_CONFIG();
      config.basic_cfg.power_source = power_source;
      ep_desc = ezb_zha_create_door_lock(ep_id, &config);
      break;
    }
    case EZB_ZHA_DOOR_LOCK_CONTROLLER_DEVICE_ID: {
      ezb_zha_door_lock_controller_config_t config = EZB_ZHA_DOOR_LOCK_CONTROLLER_CONFIG();
      config.basic_cfg.power_source = power_source;
    ...
    case EZB_ZHA_DIMMABLE_LIGHT_DEVICE_ID: {
      ezb_zha_dimmable_light_config_t config = EZB_ZHA_DIMMABLE_LIGHT_CONFIG();
      config.basic_cfg.power_source = power_source;
      ep_desc = ezb_zha_create_dimmable_light(ep_id, &config);
      break;
    }
    case EZB_ZHA_COLOR_DIMMABLE_LIGHT_DEVICE_ID: {
      ezb_zha_color_dimmable_light_config_t config = EZB_ZHA_COLOR_DIMMABLE_LIGHT_CONFIG();
      config.basic_cfg.power_source = power_source;
      ep_desc = ezb_zha_create_color_dimmable_light(ep_id, &config);
      break;
    }
    case EZB_ZHA_DIMMER_SWITCH_DEVICE_ID: {
      ezb_zha_dimmer_switch_config_t config = EZB_ZHA_DIMMER_SWITCH_CONFIG();
      config.basic_cfg.power_source = power_source;
      ep_desc = ezb_zha_create_dimmer_switch(ep_id, &config);
      break;
    }
    case EZB_ZHA_COLOR_DIMMER_SWITCH_DEVICE_ID: {
      ezb_zha_color_dimmer_switch_config_t config = EZB_ZHA_COLOR_DIMMER_SWITCH_CONFIG();
      config.basic_cfg.power_source = power_source;
    ...
    case EZB_ZHA_SHADE_DEVICE_ID: {
      ezb_zha_shade_config_t config = EZB_ZHA_SHADE_CONFIG();
      config.basic_cfg.power_source = power_source;
      ep_desc = ezb_zha_create_shade(ep_id, &config);
      break;
    }
    case EZB_ZHA_SHADE_CONTROLLER_DEVICE_ID: {
      ezb_zha_shade_controller_config_t config = EZB_ZHA_SHADE_CONTROLLER_CONFIG();
      config.basic_cfg.power_source = power_source;
    ...
    case EZB_ZHA_WINDOW_COVERING_CONTROLLER_DEVICE_ID: {
      ezb_zha_window_covering_controller_config_t config = EZB_ZHA_WINDOW_COVERING_CONTROLLER_CONFIG();
      config.basic_cfg.power_source = power_source;
      ep_desc = ezb_zha_create_window_covering_controller(ep_id, &config);
      break;
    }
    case EZB_ZHA_THERMOSTAT_DEVICE_ID: {
      ezb_zha_thermostat_config_t config = EZB_ZHA_THERMOSTAT_CONFIG();
      config.basic_cfg.power_source = power_source;
    ...
    case EZB_ZHA_CUSTOM_GATEWAY_DEVICE_ID: {
      ezb_zha_custom_gateway_config_t config = EZB_ZHA_CUSTOM_GATEWAY_CONFIG();
      config.basic_cfg.power_source = power_source;
