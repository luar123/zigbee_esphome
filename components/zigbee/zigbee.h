...
class ZigBeeComponent : public Component {
 public:
  ...
  void handle_report_attribute(uint8_t dst_endpoint, uint16_t cluster, esp_zb_zcl_attribute_t attribute, esp_zb_zcl_addr_t src_address, uint8_t src_endpoint);
  void searchBindings();
